...
public class LonginTestCont {
	...
	public void init() {
		...
		if (browser.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\mwamb\\Selenium\\testingTestNG\\driver\\chromedriver.exe");
			driver = new ChromeDriver();

		} else if(browser.equalsIgnoreCase("firefox")){

			System.setProperty("webdriver.gecko.driver", "C:\\Users\\mwamb\\Selenium\\testingTestNG\\driver\\geckodriver.exe");
